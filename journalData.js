...
export const JOURNAL_ENTRIES = [
    {
        id: 0,
        title: "Day -3: Preparation",
        text: "The old man at the tavern spoke of the Sunken Citadel with equal parts fear and greed. He claims a Wyrm of immense size slumbers in the lowest depths, guarding a hoard that would shame kings. Alaric, Thorne, and Elara have agreed to the expedition. We spent the day gathering supplies—torches, rope, rations, and weapons. Alaric's blade is sharp, and Elara's spells are prepared. I feel a mix of excitement and dread. What lies beneath those ruins?"
    },
    {
        id: 1,
        title: "Day 1: The Ruins",
        text: "We have breached the outer seal. The air here is stale. The first level is a maze of crumbling stone work, choked with roots that have broken through the ceiling. We dispatched a few giant rats, nothing troubling. But the shadows seem to stretch longer than they should. Thorne found a strange coin, pulsating with a faint heat. We press on."
    },
    {
        id: 2,
