export function createBloodStainVisuals(worldX, worldZ, sizeMultiplier, cellSize, grid, gridWidth, gridHeight) {
    const visuals = {
        floorStain: null,
        wallStain: null
    };
    ...
    if (Math.random() < 0.3 * sizeMultiplier) {
        ...
        for (let wall of walls) {
            ...
            if (checkX >= 0 && checkX < gridWidth &&
                ...
                visuals.wallStain = wallSplatter;
